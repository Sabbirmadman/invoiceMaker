...
import { selectAllTemplates, selectCustomTemplates } from "@/store";
            ...
            <main className="max-w-4xl mx-auto px-6 py-8">
                {templates.length === 0 ? (
                    <p className="text-muted-foreground">
                        No templates available for this document type yet.
                    </p>
                ) : (
                                ...
                                >
                                    ...
                                    <CardHeader className="p-0">
                                        ...
                                        <div className="px-4 pt-3 pb-3 flex items-start justify-between">
                                            ...
                                            {isCustom && (
                                                <Badge variant="secondary" className="text-xs shrink-0 ml-2">Custom</Badge>
                                            )}
                                        </div>
                                    </CardHeader>
                                </Card>
